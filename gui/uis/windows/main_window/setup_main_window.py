...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        self.logo_svg = QSvgWidget(Functions.set_svg_image("B_E_B_I.svg"))
        ...
        self.line_edit_name = PyLineEdit(
            text = "",
            place_holder_text = "Enter your name",
            radius = 8,
            border_size = 2,
            color = self.themes["app_color"]["text_foreground"],
        ...
        self.line_edit_name.setMinimumHeight(50)
        
        self.line_edit_image = PyLineEdit(
            text = "",
            place_holder_text = "Enter the image",
            radius = 8,
            border_size = 2,
            color = self.themes["app_color"]["text_foreground"],
            selection_color = self.themes["app_color"]["white"],
        ...
        self.line_edit_image.setMinimumHeight(50)
        self.line_edit_image.connect_to_function(lambda: MainFunctions.browse_image(self, self.line_edit_image))
        
        # PUSH BUTTON ADD USER
        self.push_button_add_user = PyPushButton(
            text = "Add user",
            radius = 8,
            color = self.themes["app_color"]["text_foreground"],
            bg_color = self.themes["app_color"]["dark_one"],
        ...
        self.push_button_add_user.setMinimumHeight(40)
        self.push_button_add_user.setFixedWidth(240)
        self.push_button_add_user.setIcon(self.icon_2)
        self.push_button_add_user.clicked.connect(lambda: MainFunctions.confirm_user(self, self.line_edit_name.text(), self.line_edit_image.text()))
        # self.push_button_add_user.clicked.connect(lambda: MainFunctions.show_notification(self))
        ...
        self.column_2.setText("TIME")

        self.column_3 = QTableWidgetItem()
        self.column_3.setTextAlignment(Qt.AlignCenter)
        self.column_3.setText("IMAGE URL")
        ...
        # self.history_list = MainFunctions.fetch_history_from_firebase(self, "msg")
        
        # for user in self.history_list:
